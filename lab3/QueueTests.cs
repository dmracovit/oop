...
namespace Task1.Test
{
    public class QueueTests
    {
        ...
        public void TestEnqueueDequeue()
        {
            ...
            Car car1 = new Car { Id = 1, Type = "ELECTRIC", Passengers = "PEOPLE", IsDining = false, Consumption = 14 };
            Car car2 = new Car { Id = 2, Type = "GAS", Passengers = "PEOPLE", IsDining = false, Consumption = 20 };
